...
def main(argv: list[str]) -> int:
    ...
    print()
    print("# Flip this to true once a HUMAN has actually been through the list.")
    ...
    print("# An LLM re-reading this list does not count: it is grading its own")
    print("# output, so it agrees with itself and the score stays 1.000 no")
    print("# matter how the extraction actually did.")
